...
class ScraperOrchestrator:
    ...
    def run_all(self) -> DiagnosticPanelBatch:
        ...
        batch = DiagnosticPanelBatch(
            ...
            total_genes_all_providers=total_genes,
    ...
    def generate_summary(self, batch: DiagnosticPanelBatch) -> str:
        ...
        report.append(f"Run Time: {batch.scraped_at}")
        report.append(f"Total Providers: {batch.total_providers}")
        report.append(f"Total Genes (All Providers): {batch.total_genes_all_providers}")
        report.append("")
