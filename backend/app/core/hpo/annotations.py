...
class HPOAnnotations(HPOAPIBase):
    ...
    async def get_term_annotations(self, hpo_id: str) -> Optional[TermAnnotations]:
        """
    ...
    async def get_disease_annotations(self, disease_id: str) -> Optional[DiseaseAnnotations]:
        """
