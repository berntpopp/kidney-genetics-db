    ...
    async def store_evidence(
        ...
        for symbol, data in gene_data.items():
            ...
            if gene_id in existing_map:
                ...
                # Restructure to provider->panels mapping
                ...
                all_panels = set()
                all_providers = list(provider_panels.keys())
                for panels in provider_panels.values():
                ...
                record = GeneEvidence(
                    ...
                    source_detail=f"1 provider, {data['panel_count']} panels",
                    evidence_data={
