...
class Gene(Base, TimestampMixin):
    ...
    annotations = relationship("GeneAnnotation", back_populates="gene", cascade="all, delete-orphan")
...
class GeneCuration(Base, TimestampMixin):
    ...
    panelapp_panels: Column[list[str] | None] = Column(ARRAY(Text), default=list)
    literature_refs: Column[list[str] | None] = Column(ARRAY(Text), default=list)
    diagnostic_panels: Column[list[str] | None] = Column(ARRAY(Text), default=list)
    hpo_terms: Column[list[str] | None] = Column(ARRAY(Text), default=list)
    pubtator_pmids: Column[list[str] | None] = Column(ARRAY(Text), default=list)
