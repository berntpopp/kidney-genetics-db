...
class CRUDGene:
    ...
    def get_multi_with_scores(
        ...
        params: dict[str, str | int | float] = {"skip": skip, "limit": limit}
    ...
    def get_genes_with_aggregated_data(
        ...
        try:
            ...
            # Fallback to simpler implementation if complex query fails
            return self.get_multi_with_scores(
    ...
    def get_multi_with_scores_and_sources(
        ...
        return self.get_genes_with_aggregated_data(
            db, skip, limit, search, min_score, sort_by, sort_desc
        )
