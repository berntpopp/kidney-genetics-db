<template>
  <div v-if="gtexData || descartesData" class="gene-expression">
    ...
    <!-- GTEx Expression -->
    <div v-if="gtexData" class="d-flex align-center flex-wrap ga-2 mb-2">
      <span class="text-caption text-medium-emphasis" style="width: 50px">GTEx:</span>
    ...
    <div v-if="descartesData" class="d-flex align-center flex-wrap ga-2">
      <span class="text-caption text-medium-emphasis" style="width: 50px">scRNA:</span>
      ...
      <v-tooltip v-if="descartesData.kidney_tpm !== null" location="bottom">
        ...
        <div class="pa-2">
          ...
          <div class="text-caption mt-1">TPM: {{ descartesData.kidney_tpm?.toFixed(2) || 'N/A' }}</div>
      ...
      <v-tooltip v-if="descartesData.kidney_percentage !== null" location="bottom">
        ...
        <div class="pa-2">
          ...
          <div class="text-caption">Descartes Human Cell Atlas</div>
          <div class="text-caption mt-1">
            {{ (descartesData.kidney_percentage * 100)?.toFixed(2) }}% of kidney cells express this
            gene
          </div>
        </div>
      </v-tooltip>
...
// Color functions
const getTPMColor = (tpm?: number): string => {
...
const getTPMInterpretation = (tpm?: number): string => {
