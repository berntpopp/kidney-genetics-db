          ...
          <v-col cols="12" md="6" lg="4">
            <v-card height="100%" class="info-card">
              ...
              <v-card-text class="pb-2 pt-2">
                ...
                <div v-if="clinvarData && clinvarData.total_variants > 0" class="mt-2">
                  <v-divider class="my-1" />
                  ...
                  <div class="d-flex align-center flex-wrap ga-1">
                    ...
                    <v-tooltip location="bottom">
                      ...
                      <div class="pa-2">
                        ...
                        <div class="text-caption">
                          All variants submitted to ClinVar for {{ gene.approved_symbol }}
                        </div>
                        <div class="text-caption mt-1">
                    ...
                    >
                      <template #activator="{ props }">
                        <v-chip
                          ...
                          v-bind="props"
                        >
                          {{ clinvarData.pathogenic_count + clinvarData.likely_pathogenic_count }}
                          P/LP
                        </v-chip>
                      </template>
                      <div class="pa-2">
...
const clinvarData = computed(() => {
  if (!annotations.value?.annotations?.clinvar?.[0]) return null
  return annotations.value.annotations.clinvar[0].data
})
